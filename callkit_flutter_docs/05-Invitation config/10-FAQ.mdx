...
Then, you need to set the <code>certificateIndex</code> of the **second app** to <code>secondCertificate</code> in the place where you initialize the <code>ZegoUIKitPrebuiltCallInvitationService</code> on the client side.
