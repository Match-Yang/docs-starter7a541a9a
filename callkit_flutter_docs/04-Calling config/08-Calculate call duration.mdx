...
1. Set the <code>isVisible</code> property of <code>ZegoCallDurationConfig</code> to display the current call timer. &#40;It is displayed by default&#41;
2. Assuming that the call duration is 5 minutes, the call will automatically end when the time is up &#40;refer to the following code&#41;. You will be notified of the end of the call duration through <code>durationConfig.onDurationUpdate</code>. To end the call, you can call the <code>hangUp</code> method of <code>ZegoUIKitPrebuiltCallController</code>.
